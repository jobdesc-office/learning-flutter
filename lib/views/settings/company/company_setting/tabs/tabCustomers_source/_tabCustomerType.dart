...
class _TabCustomerType extends StatelessWidget
    implements IndexViewContract, EditViewContract {
  final BuildContext context;
  final presenter = Get.find<StBpTypeCustomerTypePresenter>();
  _TabCustomerType(this.context) {
    presenter.datatables(context);
    presenter.stBpTypeCustomerTypeViewContract = this;
    presenter.stBpTypeCustomerTypeFetchDataContract = this;
  }
            ...
            child:
              ...
              if (_sources.stbpcustomertype.isNotEmpty)
                Container(
                  ...
                  child: Column(
                    children: _sources.stbpcustomertype.map((e) {
                      int index = _sources.stbpcustomertype.indexOf(e);
                      return BsRow(
  ...
  void onLoadDatatables(BuildContext context, Response response) {
    ...
    _sources.stbpcustomertype.value = stbpraw;
  }
