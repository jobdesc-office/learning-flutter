...
final _cpresenter = Get.find<ProspectiveCustomerPresenter>();
final map = Get.put(MapSource());

class ProspectiveCustomersFormController extends GetxController {
...
class ProspectiveCustomersFormSource {
  final ProspectiveCustomersFormController controller;
  final map = Get.put(MapSource());
  final ProspectiveCustomerPresenter presenter =
      Get.find<ProspectiveCustomerPresenter>();

  ProspectiveCustomersFormSource(this.controller);
