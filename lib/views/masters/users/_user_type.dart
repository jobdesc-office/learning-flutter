...
class UserTypeOptions extends StatefulWidget {
  ...
  final UserTypeOptionsController controller;
...
class _UserTypeOptions extends State<UserTypeOptions> {
  @override
  void initState() {
    super.initState();
  }
