...
class RoleForm {
  ...
  RoleForm(this.source);

  Widget inputName() {
    return FormGroup(
      label: Obx(() => Text(RoleText.labelName,
          style: TextStyle(
              color:
      ...
      child: CustomInput(
        ...
        hintText: BaseText.hintText(field: RoleText.labelName),
        validators: [
          Validators.inputRequired(RoleText.labelName),
          Validators.maxLength(RoleText.labelName, 150),
        ],
      ),
    );
  }
