  ...
  void onSuccessFetchData(Response response) {
    ...
    source.update((val) {
      ...
      source.value.choosedSubdistrict.setSelected(BsSelectBoxOption(
          value: village.villagesubdistrictid,
          text: Text(village.villagesubdistrict?.subdistrictname ?? '')));

      source.value.createdby.value =
          village.villagecreatedby?.userfullname ?? '';
      source.value.createddate.value = village.createddate ?? '';
      source.value.updatedby.value =
          village.villageupdatedby?.userfullname ?? '';
      source.value.updateddate.value = village.updateddate ?? '';
      source.value.isactive.value = village.isactive ?? true;
    });
  }
}
