...
class MenuFormView extends StatelessWidget
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (source.value.isAdd.value == false)
                          menuForm.checkbox(),
                        Obx(
                          () => Row(
  ...
  void onSuccessFetchData(Response response) {
    ...
    source.update((val) {
      ...
      source.value.createdby.value = menu.menucreatedby?.userfullname ?? '';
      source.value.createddate.value = menu.createddate ?? '';
      source.value.updatedby.value = menu.menuupdatedby?.userfullname ?? '';
