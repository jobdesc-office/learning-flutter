...
class ProspectCustomFieldFormView extends StatelessWidget
    implements EditViewContract {
  final GlobalKey<FormState> formState = GlobalKey<FormState>();
  final ProspectCustomFieldPresenter presenter =
      Get.find<ProspectCustomFieldPresenter>();
  final source = ProspectCustomFieldSource().obs;
  final Function(Map<String, dynamic> body) onSave;

  late ProspectCustomFieldForm prospectForm;

  ProspectCustomFieldFormView({required this.onSave, id}) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: TemplateView(
        ...
        child: Obx(() {
          prospectForm = ProspectCustomFieldForm(source.value);
          return Form(
            key: formState,
            child: Column(
              children: [
  ...
  void onSuccessFetchData(Response response) {
    ...
    //       value: prospect.ProspectCustomFieldto,
    //       text: Text(prospect.ProspectCustomField!.user!.userfullname.toString())));
    ...
    //   source.value.inputDesc.text = prospect.ProspectCustomFielddesc.toString();
    // });
  }
}
