...
class MassProspectContactFormView extends StatelessWidget
  ...
  late MassProspectContactForm prospectContactForm;

  MassProspectContactFormView({required this.onSave, id}) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: TemplateView(
        ...
        child: Obx(() {
          prospectContactForm = MassProspectContactForm(source.value);
          return Container(
