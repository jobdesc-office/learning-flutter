...
class TabAppsProspectCustomfield extends StatelessWidget {
  const TabAppsProspectCustomfield({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Obx(() => source.prospectcustomfieldhistories
