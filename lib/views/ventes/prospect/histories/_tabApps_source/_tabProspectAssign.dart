...
class TabAppsProspectAssign extends StatelessWidget {
  const TabAppsProspectAssign({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Obx(() => source.prospectassignhistories
              .where((p0) => p0.historysource != 'web')
              .isNotEmpty
          ? Column(
              children: source.prospectassignhistories
                  .where((p0) => p0.historysource != 'web')
