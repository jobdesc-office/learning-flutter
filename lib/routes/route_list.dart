...
class RouteList {
  ...
  static final RouteData masterBusinessPartner = RouteData(prefix: '/masters/businesspartner');

  static final RouteData type = RouteData(prefix: '/-type');
  static final RouteData region = RouteData(prefix: '/-region');
  static final RouteData masterTypeParent = RouteData(prefix: '/masters/typeparent');
  static final RouteData masterSecurityGroup = RouteData(prefix: '/masters/securitygroup');
  static final RouteData masterTypeChildren = RouteData(prefix: '/masters/typechildren');
  static final RouteData customer = RouteData(prefix: '/-customer');
  static final RouteData masterCustomer = RouteData(prefix: '/masters/customer');
  static final RouteData masterCountry = RouteData(prefix: '/masters/country');
  static final RouteData masterProvince = RouteData(prefix: '/masters/province');
  static final RouteData masterCity = RouteData(prefix: '/masters/city');
  static final RouteData masterSubdistrict = RouteData(prefix: '/masters/subdistrict');
  ...
  static final RouteData masterRole = RouteData(prefix: '/masters/role');
  ...
  static final RouteData ventesChat = RouteData(prefix: '/ventes/chat');
  ...
  static final RouteData ventesBpCustomer = RouteData(prefix: '/ventes/bpcustomer');
  static final RouteData ventesCompetitor = RouteData(prefix: '/ventes/competitor');

  static final RouteData settings = RouteData(prefix: '/-settings');

  static final RouteData settingsPrevileges = RouteData(prefix: '/settings/previleges');
  static final RouteData settingsCustomField = RouteData(prefix: '/settings/customfield');

  static final RouteData settingsCompany = RouteData(prefix: '/settings/company');
  static final RouteData settingsInformation = RouteData(prefix: '/settings/information');

  static final RouteData settingsPermission = RouteData(prefix: '/settings/permission');
