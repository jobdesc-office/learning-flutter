...
import '../../views/ventes/prospect/prospectassign/prospect_detail.dart';
import '../../views/ventes/prospect/prospectassign/prospectassign_form.dart';
import '../../widgets/confirm_dialog.dart';

class ProspectAssignPresenter extends CustomGetXController {
  final _prospectService = Get.find<ProspectAssignService>();
  ...
  set ProspectAssignViewContract(DetailViewContract prospectViewContract) {
  ...
  void add(BuildContext context, int id) async {
    showDialog(
      context: context,
      builder: (context) =>
          ProspectAssignFormView(onSave: (body) => save(context, body), id: id),
    );
  }
  ...
  void detail(BuildContext context, int userid) async {
    ...
    showDialog(
      context: context,
      builder: (context) => ProspectAssignDetails(),
    );
  ...
  void edit(BuildContext context, int Prospectid, int id) async {
    ...
    showDialog(
      context: context,
      builder: (context) => ProspectAssignFormView(
