class HomeModel {
  List<MySchedules>? mySchedules;
  List<MySchedulesGuest>? mySchedulesGuest;

  HomeModel({this.mySchedules, this.mySchedulesGuest});

  HomeModel.fromJson(Map<String, dynamic> json) {
    if (json['mySchedules'] != null) {
      mySchedules = <MySchedules>[];
      json['mySchedules'].forEach((v) {
        mySchedules!.add(new MySchedules.fromJson(v));
      });
    }
    if (json['mySchedulesGuest'] != null) {
      mySchedulesGuest = <MySchedulesGuest>[];
      json['mySchedulesGuest'].forEach((v) {
        mySchedulesGuest!.add(new MySchedulesGuest.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.mySchedules != null) {
      data['mySchedules'] = this.mySchedules!.map((v) => v.toJson()).toList();
    }
    if (this.mySchedulesGuest != null) {
      data['mySchedulesGuest'] =
          this.mySchedulesGuest!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class MySchedules {
  ...
  MySchedules.fromJson(Map<String, dynamic> json) {
    scheid = json['scheid'];
    schenm = json['schenm'];
...
class MySchedulesGuest {
  ...
  MySchedulesGuest.fromJson(Map<String, dynamic> json) {
    scheguestid = json['scheguestid'];
    scheid = json['scheid'];
    scheuserid = json['scheuserid'];
    schebpid = json['schebpid'];
    ...
    scheuser = json['scheuser'] != null
        ? new Schetoward.fromJson(json['scheuser'])
        : null;
    schebp =
        json['schebp'] != null ? new Schebp.fromJson(json['schebp']) : null;
