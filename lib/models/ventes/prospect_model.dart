...
class ProspectModel {
  ...
  ProspectModel.fromJson(Map<String, dynamic> json) {
    ...
    prospectupdatedby = json['prospectupdatedby'] != null
        ? new Prospectupdatedby.fromJson(json['prospectupdatedby'])
        : null;
    ...
    prospectby = json['prospectby'] != null
        ? new Prospectupdatedby.fromJson(json['prospectby'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.prospectupdatedby != null) {
      data['prospectupdatedby'] = this.prospectupdatedby!.toJson();
    }
...
class Prospectupdatedby {
  ...
  Prospectupdatedby.fromJson(Map<String, dynamic> json) {
    userid = json['userid'];
...
class Prospectassigns {
  ...
  Prospectupdatedby? prospectreportss;
  ...
  Prospectassigns.fromJson(Map<String, dynamic> json) {
    ...
    prospectassignss = json['prospectassignss'] != null
        ? new Prospectupdatedby.fromJson(json['prospectassignss'])
        : null;
    prospectreportss = json['prospectreportss'] != null
        ? new Prospectupdatedby.fromJson(json['prospectreportss'])
        : null;
  }
...
class Prospectcust {
  ...
  Prospectcust.fromJson(Map<String, dynamic> json) {
    ...
    if (json['sbccontact'] != null) {
      sbccontact = <Sbccontact>[];
      json['sbccontact'].forEach((v) {
        sbccontact!.add(new Sbccontact.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.sbccontact != null) {
      data['sbccontact'] = this.sbccontact!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class Sbccontact {
  ...
  Sbccontact.fromJson(Map<String, dynamic> json) {
