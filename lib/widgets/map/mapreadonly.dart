...
class GoogleMapsRead extends StatefulWidget {
  final CameraPosition camera;
  const GoogleMapsRead({Key? key, required this.camera});

  @override
  _GoogleMapsReadState createState() => _GoogleMapsReadState();
}

class _GoogleMapsReadState extends State<GoogleMapsRead>
